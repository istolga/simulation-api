...
/**
 * class to define spring configuration using annotations
 */
@Configuration
@ComponentScan(basePackages = {
    "com.simapi"
}, excludeFilters = @ComponentScan.Filter(value = org.springframework.context.annotation.Configuration.class,
  type = FilterType.ANNOTATION))
@PropertySource("classpath:sim_api.properties")
public class AppConfig {
    ...
    static {
        try {
            ...
            System.out.println("log4j in not initialized, can't find sim-api-log4j.properties in classpath");
        }
        
        LOGGER = LogFactory.getLog(AppConfig.class);
    }
    ...
    public ApiConfig apiConfig() {
        ...
        try {
            ...
            config = (ApiConfig) unmarchaller.unmarshal(new ClassPathResource(
                    "sim-api-config.xml").getInputStream());
        }
        catch (Exception e) {
